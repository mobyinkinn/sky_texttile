...
//   title:
//   "Best Spinning Mills and Fabric Manufacturing Company in Ahmedabad, Gujarat, India & Asia: SKY Textiles",
//   description:
...
const fetchData = async () => {
  try {
    const response = await axios.get(
      "https://sky-backend-bvuy.onrender.com/api/v1/seo/getByPageName?pagename=skyTextiles"
    );
  ...
  return (
    <>
      <h1 style={{ display: "none" }}>
        Best Spinning Mills and Fabric Manufacturing Company in Ahmedabad,
        Gujarat, India & Asia: SKY Textiles
      </h1>
      ...
      <h2 style={{ display: "none" }}>Process </h2>
      <h2 style={{ display: "none" }}>Knitting </h2>
      <h2 style={{ display: "none" }}>Current Job Opportunities </h2>
